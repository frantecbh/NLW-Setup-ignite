...
export function HabitDay({amount = 0 , defaultCompleted = 0, date}: HabitProps) {
...
function handleCompletedCahnged(completed: number){
    ...
    <Popover.Root>
      ...
      <Popover.Portal>
       ...
       <ProgressBar progress={comlpetedPercentage} />
        ...
        <HabitsList date={date} onCompletedChanged={handleCompletedCahnged} />
